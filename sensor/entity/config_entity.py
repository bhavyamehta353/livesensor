...
# this class will make use of the training pipeline constant values formed in the constant directory.
...
# this class will make use of the data ingestion constant values formed in the constant directory(create paths)
